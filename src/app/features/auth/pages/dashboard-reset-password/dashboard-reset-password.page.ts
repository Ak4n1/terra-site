...
@Component({
  selector: 'app-dashboard-reset-password-page',
  standalone: true,
  imports: [CommonModule, AlertComponent, ButtonComponent, ProgressBarComponent, InputFieldComponent],
  templateUrl: './dashboard-reset-password.page.html',
  styleUrl: './dashboard-reset-password.page.css'
})
export class DashboardResetPasswordPage {
